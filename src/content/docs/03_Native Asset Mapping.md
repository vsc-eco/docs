...
- Enables Magi to serve as a unified settlement layer within its supported network of blockchains. The Magi protocol keeping track of who owns what, across all supported chains, with finality.
