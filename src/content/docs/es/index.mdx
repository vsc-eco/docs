...
- **Mapeo de activos nativos:** VSC permite que los activos de diferentes blockchains (por ejemplo, BTC, SOL, Hive, ETH) se bloqueen de forma segura en sus cadenas nativas y se mapeen a direcciones conectadas a VSC. Por ejemplo: esto permite que las direcciones de carteras de Ethereum mantengan Bitcoin (BTC) nativo, que las direcciones de carteras de Solana mantengan Ethereum (ETH) nativo, y viceversa, todo mientras se aprovecha la red descentralizada de validadores de VSC para una interoperabilidad entre cadenas fluida.
