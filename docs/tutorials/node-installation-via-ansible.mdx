---
title: Node installation via ansible
---

# Node installation via ansible
...
## Text based Ansible instructions
...
The bare_metal ansible installation is currently not completed.
